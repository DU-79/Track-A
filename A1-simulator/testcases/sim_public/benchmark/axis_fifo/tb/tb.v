...
reg [DATA_WIDTH-1:0] exp_m_axis_tdata = 0;
reg [KEEP_WIDTH-1:0] exp_m_axis_tkeep = 0;
...
initial begin : main
    ...
    $fdisplay(output_fd, "s_axis_tready,m_axis_tdata[63:0],m_axis_tkeep[7:0],m_axis_tvalid,m_axis_tlast,m_axis_tid[7:0],m_axis_tdest[7:0],m_axis_tuser");
    ...
    for (cycle = 0; cycle < CYCLE_COUNT; cycle = cycle + 1) begin
        ...
        $fdisplay(output_fd, "%b,%b,%b,%b,%b,%b,%b,%b",
            s_axis_tready,
            m_axis_tdata,
            m_axis_tkeep,
            m_axis_tvalid,
